  ...
  if (cognitoUser != null) {
    cognitoUser.getSession(function (err, session) {
      ...
      cognitoUser.getUserAttributes(function (err, result) {
        ...
        // logoutButton.innerHTML = '<li onclick="signOut"><a href=""></a></li> > Logout</button>'

        // logoutButton.innerHTML = '<li onclick="signOut()" > Logout</li>'
      });
    });
  }
};
...
window.addEventListener('load', fetchProducts, false);
        ...
        async function fetchProducts() {
            ...
            let url = `https://yszluxm1vb.execute-api.us-west-2.amazonaws.com/dev/getproducts`;
            axios(url, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
...
async function addtocart() {
  let url =
    "https://02aibqsilb.execute-api.us-west-2.amazonaws.com/opensearch-api-test/cart";
  axios(url, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
